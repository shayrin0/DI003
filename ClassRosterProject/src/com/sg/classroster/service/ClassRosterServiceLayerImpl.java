...
public class ClassRosterServiceLayerImpl implements ClassRosterServiceLayer {
    ...
    /*
    Ensure that the incoming Student Id does not already exist
    Validate that all the fields in the incoming Student object have values
    Pass the incoming Student object to the DAO so that it can persist it
     */
    @Override
